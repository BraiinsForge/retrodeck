...
;; When the Lisp tree is compiled into the binary the definitions are
;; already present; only the local.lisp hot-patch overlay still loads.
(unless (member :retrodeck-image *features*)
